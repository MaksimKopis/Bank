...
function refreshInfoBox(){
    ...
    <h3>Card number: <span class="cardNumber"> ${card1.getCardOptions().key}</span></h3>
        ...
        <h3>Card transaction limit: <span class="cardTransactionLimit">${card1.getCardOptions().transactionLimit}</span></h3>
        <h3>Card history logs: <span class="cardHistoryLogs">${card1.getCardOptions().historyLogs}</span></h3>
    `;
}
